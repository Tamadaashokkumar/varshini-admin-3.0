...
//                     <span
//                       className={`absolute -left-[29px] top-1 h-3 w-3 rounded-full border-2 border-[#1e1e1e] ${idx === order.statusHistory!.length - 1 ? "bg-green-500" : "bg-gray-600"}`}
//                     ></span>
//                     <p className="text-sm font-medium text-white">
//                       {history.status}
//                     </p>
...
//                   <div
//                     key={idx}
//                     className="flex flex-col gap-3 rounded-xl bg-white/5 p-3 border border-white/5"
//                   >
...
//                             }
//                             className="px-3 py-1 rounded-lg bg-green-500/20 text-green-400 text-xs hover:bg-green-500/30 transition"
//                           >
//                             Approve
//                           </button>
//                           <button
...
//           OrderService.updateStatus(id, { orderStatus: status }),
//         ),
//       );
//       toast.dismiss();
...
//           className="bg-blue-500/10 border border-blue-500/20 p-3 rounded-xl flex items-center justify-between"
//         >
//           <div className="flex items-center gap-3">
...
//               className="text-xs font-medium text-white hover:text-blue-300 transition"
//             >
//               Mark Shipped
//             </button>
//             <button
...
//                       }}
//                       className={`group ${isSelected ? "bg-blue-500/5" : ""}`}
//                     >
//                       {/* 🔥 Checkbox Cell */}
